...
#endif // (WEAVE_DEVICE_CONFIG_EVENT_LOGGING_PROD_BUFFER_SIZE <= 0)
...
#endif // (WEAVE_DEVICE_CONFIG_EVENT_LOGGING_CRIT_BUFFER_SIZE <= 0)
...
#endif // WEAVE_DEVICE_CONFIG_EVENT_ID_COUNTER_EPOCH
