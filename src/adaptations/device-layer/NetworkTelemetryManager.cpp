...
WEAVE_ERROR NetworkTelemetryManager::Init(void)
{
    ...
    mTunnelTopology.Init(WEAVE_DEVICE_CONFIG_DEFAULT_TUNNEL_TELEMETRY_INTERVAL_MS);
#endif
...
#if WEAVE_DEVICE_CONFIG_ENABLE_TUNNEL_TELEMETRY
void TunnelTopology::GetTelemetryStatsAndLogEvent(void)
{
    ...
    WeaveLogProgress(DeviceLayer, "Tunnel Tolopoly Stats event: %u\n", eventId);
